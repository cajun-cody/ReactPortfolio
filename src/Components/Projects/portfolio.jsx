...
import rouxTube from '../../Assets/rouxtube.png';
    ...
    <section class="portfolio" id="portfolio">
        ...
        <div class="portfolio-container">
            <div class="portfolio-box">
                ...
                <h4 class="portfolio-title">Gamer Music Library Full Stack</h4>
            ...
            <div class="portfolio-box">
                ...
                <div class="portfolio-layer">                
                    ...
                    <div class="project-links">
                        <a href="https://github.com/cajun-cody/Music_Library_Frontend"><i class='bx bxl-github'></i></a>
                        <a href="https://github.com/cajun-cody/Music_Library_Backend"><i class='bx bxl-github'></i></a>
                        <a href="https://youtu.be/Z-0LsSIIKtY"><i class='bx bxl-youtube'></i></a>
                    </div>                   
                </div>
            </div>
            <div class="portfolio-box">
                <img src={rouxTube} alt=""/>
                <h4 class="portfolio-title">RouxTube Full Stack</h4>
                <div class="portfolio-layer">
                    ...
                    <p>Tech Stack: Python/Django, MySQL, JavaScript/React, YouTube API</p>
                    <div class="project-links">
                        <a href="https://github.com/cajun-cody/YouTube_Clone"><i class='bx bxl-github'></i></a>
                        <a href="https://youtu.be/lJpSXFZ8jKs"><i class='bx bxl-youtube'></i></a>
            ...
            <div class="portfolio-box">
                ...
                <h4 class="portfolio-title">Book Nook Full Stack</h4>
                <div class="portfolio-layer">              
                    ...
                    <p>Tech Stack: C#/ASP.NET Web API, MySQL, JavaScript/React</p>
                    <div class="project-links">
            ...
            <div class="portfolio-box">
                <img src={project1} alt=""/>
                <h4 class="portfolio-title">Lemonade Stand Terminal Game</h4>
                <div class="portfolio-layer">
                    ...
                    <p>Tech Stack: C#, Visual Studio, OOP</p>
                    <div class="project-links">
